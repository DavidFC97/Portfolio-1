    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="We'll collaborate to map out your website's goa;s, target audience, and key funcionalities. We'll discuss things like site structure, navigation and content requirements"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="This is where tje magic happends! Based on the approved desig, I'll translate everything into functional code, building your website from the ground up."
        >
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[50%] lef-[50%] translate-x-[-50%] translate-y-[] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
